...
class Route
{
    ...
    /** @var Middlewares[] Currently middlewares active */
     ...
     */
    public function __construct($expr, $callback, $methods = null, $middlewares = null)
    {
    ...
    public function exec()
    {
        if(gettype($this->callback) == 'array'){
            $this->callback[0]->middleware($this->middlewares);
        }
