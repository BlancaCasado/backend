...
class Router
{
    ...
    /** @var Middlewares[] Currently registered routes */
    ...
    public function __construct($base_path = '')
    {
        ...
        //echo '*/////*';
        isset($_GET['dato']) ? $path = $_GET['dato'] : $path = '';
        //echo $path;
        $this->path = '/'.$path;
    }
    ...
    {
        $this->routes[] = new Route($expr, $callback, $methods, $this->middlewares);
        $this->middlewares = [];
    }
    ...
    {
        $this->routes[] = new Route($expr, $callback, 'GET', $this->middlewares);
        $this->middlewares = [];
    }
    ...
    {
        $this->routes[] = new Route($expr, $callback, 'POST', $this->middlewares);
        $this->middlewares = [];
    }
    ...
    {
        $this->routes[] = new Route($expr, $callback, 'HEAD', $this->middlewares);
        $this->middlewares = [];
    }
    ...
    {
        $this->routes[] = new Route($expr, $callback, 'DELETE', $this->middlewares);
        $this->middlewares = [];
    }
